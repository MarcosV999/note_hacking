...
`exploit.pHp` `exploit.php.jpg` `exploit.php.` `exploit%2Ephp` --URL encoding `exploit.asp;.jpg` or `exploit.asp%00.jpg` --Semicolons or URL-encoded null byte characters `exploit.p.phphp`
